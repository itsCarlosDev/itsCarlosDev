<h1 align="center">
  Hola, soy Carlos <img width="32px" src="https://raw.githubusercontent.com/iampavangandhi/iampavangandhi/master/gifs/Hi.gif" alt="Mano saludando" />
</h1>
...
* 🏆 Ganador del **WiFi Challenge de UAB THE HACK! 2025**.
...
[projects]
team = INTERHACK BCN · Damm Logistics MVP
academic = Flight Manager C++ · OOP & Graphs

[learning]
stack = React · Django · MongoDB
areas = Cybersecurity · Computer Vision

[interests]
hardware = Arduino · Microcontrollers
maker = Drones · 3D Printing

[mindset]
mode = Learn by building
goal = Useful, secure and efficient software
```

<br>

<p align="center">
  <code>understand() → build() → validate() → improve()</code>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Divi-7B61FF?style=for-the-badge&logo=wordpress&logoColor=white" alt="Divi" />
</p>

### ⚙️ Programación y datos
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>
        Proyecto desarrollado en equipo para el reto logístico de Damm, con planificación de rutas, organización de carga, visualización en mapa y apoyo con IA.
      </p>
      <p><b>Stack:</b> Django · MongoDB · JavaScript · Bootstrap · OpenStreetMap</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        Aplicación CLI desarrollada antes de empezar segundo de carrera para practicar POO, gestores, arrays reservados, ficheros, Makefile y grafos.
      </p>
      <p><b>Stack:</b> C++ · OOP · Makefile · fstream · grafos</p>
      <br>
    </td>
    <td width="50%" valign="top">
...
<p align="center">
  Me definen la <b>constancia</b>, la <b>responsabilidad</b> y las ganas de seguir aprendiendo.<br>
  Mi objetivo es contribuir a crear software útil, seguro y eficiente.
</p>
...
<p align="center">
  ...
  <sub>Siempre aprendiendo, construyendo y mejorando.</sub>
</p>
